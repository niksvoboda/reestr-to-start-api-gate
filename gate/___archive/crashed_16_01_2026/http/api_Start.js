...
const db_File   = require('../components/db_File.js')
...
class api_Start extends Log {     
    ...
    try {
        ...
        //await db_File.writeFileJSON('addProject_response', response)

        const result = await response.json();
        //console.log(result)
        //await db_File.writeFileJSON('addProject_response', result)
